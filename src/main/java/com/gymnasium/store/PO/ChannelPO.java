...
@Entity
@Table(name = "channel")
@ApiModel(value = "ChannelPO", description = "渠道")
public class ChannelPO {
    ...
    @ApiModelProperty(value = "渠道人编码", name = "channelCode", example = "1")
    private String channelCode;

    @Column(name = "level")
    @ApiModelProperty(value = "渠道等级1.一级2.二级", name = "level", example = "1")
    ...
    @ApiModelProperty(value = "服务电话", name = "servicePhone", example = "1")
