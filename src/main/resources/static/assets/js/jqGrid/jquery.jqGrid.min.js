...
(function (b) {
    ...
    b.extend(b.jgrid, {
        version: "4.5.2", htmlDecode: function (b) {
            ...
            k = h.getSeconds();
            var l = h.getMilliseconds(), o = h.getDay(), n = h.getFullYear(), m = (o + 6) % 7 + 1, t = (new Date(n, j - 1, g) - new Date(n, 0, 1)) / 864E5, A = {
                d: a(g),
                D: e.dayNames[o],
                j: g,
                l: e.dayNames[o + 7],
                    ...
                    a(e.p.colModel).each(function (r) {
                        ...
                        if ("cb" !== h && "subgrid" !== h && !0 === this.editable && "rn" !== h) {
                            ...
                            var v = a.extend({}, this.editoptions || {}, {
                                ...
                                rowabove: !1,
                                rowcontent: ""
                            }, this.formoptions || {}), w = parseInt(s.rowpos, 10) || p + 1, u = parseInt(2 * (parseInt(s.colpos,
                                    10) || 1), 10);
                    ...
                    a(d.p.colModel).each(function (b) {
                        ...
                        if ("cb" !== f && "subgrid" !== f && "rn" !== f && A) {
                            ...
                            var c = a.extend({}, {
                                rowabove: !1,
                                rowcontent: ""
                            }, this.formoptions || {}), l = parseInt(c.rowpos, 10) ||
