...
(function (b) {
    ...
    a.prototype = {
        constructor: a, initInput: function () {
    ...
    b.extend(a.prototype, {
        render: function () {
            ...
            if (typeof f === "string") {
                ...
                b.ajax({
                    url: f, type: "get", cache: false, dataType: "json", success: b.proxy(function (e) {
                        if (c) {
                            c.loading = false
                        }
...
(function (a) {
    a.extend(a.fn.editableContainer.Popup.prototype, {
        ...
        innerCss: a.fn.popover && a(a.fn.popover.Constructor.DEFAULTS.template).find("p").length ? ".popover-content p" : ".popover-content",
        initContainer: function () {
            a.extend(this.containerOptions, {
                trigger: "manual",
                selector: false,
                content: " ",
                template: a.fn.popover.Constructor.DEFAULTS.template
            });
            var b;
...
(function (g) {
    ...
    h.prototype = {
        constructor: h, _process_options: function (n) {
            ...
            this._secondaryEvents = [[this.picker, {click: g.proxy(this.click, this)}], [g(window), {resize: g.proxy(this.place, this)}], [g(document), {
                mousedown: g.proxy(function (n) {
            ...
            this.element.trigger({
                type: p, date: n, format: g.proxy(function (s) {
    ...
    var e = g.fn.datepicker.defaults = {
        autoclose: false,
    ...
    var i = {
        ...
        parseDate: function (q, A, u) {
            ...
            var t = q && q.match(this.nonpunctuation) || [], q = new Date(), y = {}, z = ["yyyy", "yy", "M", "MM", "m", "mm", "d", "dd"], B = {
                yyyy: function (E, s) {
...
(function (b) {
    ...
    a.defaults = b.extend({}, b.fn.editabletypes.date.defaults, {
        ...
        datepicker: {weekStart: 0, startView: 0, minViewMode: 0, autoclose: true}
    });
...
(function (a) {
    ...
    b.defaults = a.extend({}, a.fn.editabletypes.abstractinput.defaults, {
        ...
        formatType: "standard",
        viewformat: null,
        datetimepicker: {todayHighlight: false, autoclose: false},
        clear: "&times; clear"
    });
...
(function (b) {
    ...
    a.defaults = b.extend({}, b.fn.editabletypes.datetime.defaults, {
        ...
        inputclass: "input-medium",
        datetimepicker: {todayHighlight: false, autoclose: true}
    });
